...
void _clusterization(){
    // int _iter=0;
	// while(_header_inds.size()>2 ){
	// 	clustering();
    //     if (_iter==max_iteraciones){
    //         cout<<endl << "\ntime with "<<_iter<<"   iters     " << _time_concurrent <<" secs"<< endl;
    //         cout<<"tipo: "<<tipo<<endl;
    //         cout<<"numero de clusteres: "<<_header_inds.size();

    //         cout<<endl;
    //         cout<<endl;
    //         for (int i=0;i<matrix_numeros_final.size();i++){
    //             if (_header_inds[i].size()==7){
    //                 cout<<"Cluster "<<i<<".- "<<_header_inds[i]<<" \n";
    //             }
    //             else {
    //                 cout<<"Cluster "<<i<<".- "<<_header_inds[i]<<endl;
    //             }
    //         }
    //         cout<<endl;
    //         cout<<endl;
